...
- Git Commit：`feat: add memory retrieval`
...
```text
你正在开发 A-Quant Agent OS 的 Day 48：Memory Retrieval。
...
实现 memory semantic search + metadata filter，并将结果作为可控上下文注入 Agent。
...
## Code Review Prompt
```text
请作为 A-Quant Agent OS 的 Staff Engineer Review Day 48：Memory Retrieval。
...
请对 Day 48：Memory Retrieval 做严格验收。
