...
- Git Commit：`feat: add resource limits`
...
```text
你正在开发 A-Quant Agent OS 的 Day 54：Rate Limit 与资源控制。
...
## Code Review Prompt
```text
请作为 A-Quant Agent OS 的 Staff Engineer Review Day 54：Rate Limit 与资源控制。
...
请对 Day 54：Rate Limit 与资源控制 做严格验收。
