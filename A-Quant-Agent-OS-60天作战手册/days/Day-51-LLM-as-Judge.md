...
- Git Commit：`feat: add llm as judge evaluation`
...
```text
你正在开发 A-Quant Agent OS 的 Day 51：LLM-as-Judge。
...
## Code Review Prompt
```text
请作为 A-Quant Agent OS 的 Staff Engineer Review Day 51：LLM-as-Judge。
