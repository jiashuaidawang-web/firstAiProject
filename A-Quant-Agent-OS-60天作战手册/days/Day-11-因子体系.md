...
- Git Commit：`feat: add technical factors`
...
```text
你正在开发 A-Quant Agent OS 的 Day 11：因子体系。
...
设计 Factor 接口和计算上下文，实现 MA、RSI、MACD、Momentum、Volatility。
...
## Code Review Prompt
```text
请作为 A-Quant Agent OS 的 Staff Engineer Review Day 11：因子体系。
